...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const handleConnect = () => {
            console.log('Socket connected, re-joining...');
            socket.emit("join", { userType: "user", userId: user._id })
        };
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            <img className='w-16 absolute left-5 top-5 z-20' src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png" alt="" />
